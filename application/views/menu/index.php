             ...
             <div class="card card-frame col-lg">
                 <div class="card-body">
                     ...
                     <div class="col-lg">
                         ...
                         <div class="table-responsive" data-toggle="list" data-list-values='["id", "menu"]'>
                             <table class="table align-items-center table-flush">
                                 <button class="btn btn-icon btn-outline-primary mb-3" type="button" data-toggle="modal" data-target="#newMenuModal">
