                     ...
                     <div class="col-lg">
                         ...
                         <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                             <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                 ...
                                 <li class="breadcrumb-item"><a href="<?= base_url('admin/laporanpengeluaran') ?>">Laporan Pengeluaran</a></li>
                     ...
                     <div class="col-lg">
                         <form action="" method="POST">
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="text" id="keterangan" name="keterangan" class="form-control" placeholder="Keterangan" value="<?= $edit['keterangan'] ?>">
                             </div>
                             <?= form_error('keterangan', '<small class="text-danger">', '</small>'); ?>
                             <div class="form-group content-justify-end">
                                 <button type="submit" class="btn btn-primary float-right tombol-edit">Kirim</button>
                             </div>
                         </form>
